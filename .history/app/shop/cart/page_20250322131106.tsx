...
const CartPage = () => {
  ...
  const submitOrder = async () => {
    ...
    const fullAddress = `${formData.address}, ${formData.city} ${formData.postal}`;
  ...
  return (
    <div className="min-h-screen bg-white pt-28 pb-16 px-4 md:px-12">
      ...
      <Modal
        ...
        className="bg-white max-w-md mx-auto mt-40 p-8 rounded-xl shadow-xl text-center"
        overlayClassName="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-start z-50"
      >
        <h2 className="text-2xl font-bold mb-4">Da li ste sigurni?</h2>
